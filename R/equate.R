...
#' 
#' @param rmatA A \link[SemNetCleaner]{textcleaner} filtered response matrix for group 1
#' 
#' @param rmatB A \link[SemNetCleaner]{textcleaner} filtered response matrix for group 2
